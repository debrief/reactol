...
export const DocContextProvider: React.FC<Props> = ({ children }) => {
  ...
  const [mapEditableFeature, setMapEditableFeature] = useState<Feature<Geometry, GeoJsonProperties> | null>(null)
  ...
  return (
    <DocContext.Provider value={{ selection, setMapNode, setSelection, time, setTime, viewportFrozen, copyMapToClipboard, setViewportFrozen, message, setMessage, newFeature, setNewFeature, mapEditableFeature, setMapEditableFeature }}>
      {children}
    </DocContext.Provider>
  )
}
